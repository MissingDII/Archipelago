...
all_connections = [
    ...
    one_way_connection(RegionName.moss_grotto, RegionName.moss_grotto_after_breakable_walls, requirements=[(ItemName.leftslash, ItemName.upslash, ItemName.downslash)]),
    one_way_connection(RegionName.moss_grotto_after_breakable_walls, RegionName.moss_mother_arena),
    ...
    one_way_connection(RegionName.moss_mother_defeated, RegionName.moss_grotto_after_breakable_walls),
    one_way_connection(RegionName.bone_bottom, RegionName.moss_mother_arena),

    ConnectionData(RegionName.bone_bottom, RegionName.bonegrave, requirements=ItemName.cling_grip),
    ConnectionData(RegionName.moss_grotto_after_breakable_walls, RegionName.weavenest_atla, requirements=ItemName.needolin),
    ...
    ConnectionData(RegionName.marrow_east_bone_bottom_wishes, RegionName.marrow_east_skull_tyrant, requirements=[ItemName.cling_grip, (ItemName.rightslash, ItemName.upslash, ItemName.downslash)]),
    ...
    one_way_connection(RegionName.shellwood, RegionName.sister_splinter_arena, requirements=ItemName.downslash),
    one_way_connection(RegionName.sister_splinter_defeated, RegionName.shellwood_spire),
    one_way_connection(RegionName.sister_splinter_arena, RegionName.sister_splinter_defeated),
    one_way_connection(RegionName.sister_splinter_defeated, RegionName.shellwood),
    one_way_connection(RegionName.shellwood_spire, RegionName.sister_splinter_arena, requirements=ItemName.downslash),

    ConnectionData(RegionName.shellwood, RegionName.bellhart_upper, requirements=[(ItemName.cling_grip, ItemName.faydown_cloak)]),
    ...
    one_way_connection(RegionName.bellhart_upper, RegionName.widow_arena),
    one_way_connection(RegionName.widow_arena, RegionName.widow_defeated),
    one_way_connection(RegionName.widow_defeated, RegionName.bellhart_saved, requirements=ItemName.cling_grip),
    ...
    one_way_connection(RegionName.choral_chambers, RegionName.cogwork_dancers_arena),
    one_way_connection(RegionName.cogwork_dancers_defeated, RegionName.cogwork_core),
    one_way_connection(RegionName.cogwork_dancers_arena, RegionName.cogwork_dancers_defeated),
    one_way_connection(RegionName.cogwork_dancers_defeated, RegionName.choral_chambers),
    one_way_connection(RegionName.cogwork_core, RegionName.cogwork_dancers_arena),

    one_way_connection(RegionName.cogwork_core, RegionName.pharloom_crown, requirements=[ItemName.conductor_melody, ItemName.architect_melody, ItemName.vaultkeeper_melody]),
    ...
    ConnectionData(RegionName.choral_chambers, RegionName.the_slab_above_bellway),
    ...
    one_way_connection(RegionName.the_slab_main_area, RegionName.the_slab_above_bellway, requirements=ItemName.key_of_heretic),
    one_way_connection(RegionName.the_slab_above_bellway, RegionName.the_slab_bellway),
    ...
    one_way_connection(RegionName.the_slab_bellway, RegionName.the_slab_above_bellway, requirements=[(ItemName.cling_grip, ItemName.drifters_cloak, ItemName.faydown_cloak)]),
    ConnectionData(RegionName.the_slab_above_bellway, RegionName.the_slab_shortcut_cave, requirements=[ItemName.faydown_cloak, ItemName.key_of_apostate]),
    ...
    ConnectionData(RegionName.the_slab_shortcut_cave, RegionName.the_slab_main_area),
    ConnectionData(RegionName.the_slab_main_area, RegionName.the_slab_indolent, requirements=ItemName.key_of_indolent),
    ...
    one_way_connection(RegionName.weavenest_atla, RegionName.eva_0, requirements=[(ItemName.rightslash, ItemName.downslash), ItemName.cling_grip]),
