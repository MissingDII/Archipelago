...
all_locations_items_pairs: List[LocationItemData] = [
    ...
    item_location("Eva: 12 Slots", RegionName.eva_12, [LocationGroup.CREST_UPGRADE, LocationGroup.EVA_REWARD, LocationGroup.EVA, LocationGroup.ACT_1], ItemName.vesticrest, ItemClassification.useful),
    ...
    item_location("Eva: 20 Slots", RegionName.eva_20, [LocationGroup.CREST_UPGRADE, LocationGroup.EVA_REWARD, LocationGroup.EVA, LocationGroup.ACT_1], ItemName.vesticrest, ItemClassification.useful),
