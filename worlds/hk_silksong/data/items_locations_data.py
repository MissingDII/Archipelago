...
all_locations_items_pairs: List[LocationItemData] = [
    ...
    item_location("Wayfarer Wish: The Lost Fleas", RegionName.wish_marrow_west, [LocationGroup.RED_TOOL, LocationGroup.WISH, LocationGroup.ACT_1]),
    item_location("Wayfarer Wish: Pinmaster's Oil", RegionName.wish_whispering_vaults, [LocationGroup.WISH, LocationGroup.ACT_2]),
