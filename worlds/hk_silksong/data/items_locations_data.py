...
all_locations_items_pairs: List[LocationItemData] = [
    ...
    item_location("Bound the Crest of Witch", RegionName.yarnaby_with_steel_spines, [LocationGroup.CREST, LocationGroup.ACT_1], ItemName.crest_witch),
    item_location("Bound the Crest of Architect", RegionName.chapel_of_the_architect, [LocationGroup.CREST, LocationGroup.ACT_1], ItemName.crest_architect),
    item_location("Bound the Crest of Shaman", RegionName.ruined_chapel, [LocationGroup.CREST, LocationGroup.ACT_1], ItemName.crest_shaman),
